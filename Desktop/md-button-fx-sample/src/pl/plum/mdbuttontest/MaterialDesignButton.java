...
/*
        ...
        this.addEventHandler(MouseEvent.MOUSE_PRESSED, event -> {
        	hacerRipple(parallelTransition, scaleRippleTimeline, event.getX(), event.getY());
        });
    */    
    ...
    public void hacerRipple(final SequentialTransition parallelTransition, final Timeline scaleRippleTimeline, double X, double Y ){
