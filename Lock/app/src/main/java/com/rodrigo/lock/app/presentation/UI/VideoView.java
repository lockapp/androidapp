...
/**
 * Created by Rodrigo on 01/10/2014.
 */
             ...
             */
                    if (getWindowToken() != null) {
                        ...
                        if (framework_err == MediaPlayer.MEDIA_ERROR_NOT_VALID_FOR_PROGRESSIVE_PLAYBACK) {
                            messageId =  getResources().getString(R.string.VideoView_error_text_invalid_progressive_playback);;
                        } else {
                            messageId = getResources().getString(R.string.VideoView_error_text_unknown);
                        }
