package com.rodrigo.lock.app.old.Core.crypto.AES;
...
public class CoreCryptoV0 {
    ...
    public class AES implements CoreCrypto {
        ...
        public Cipher getCiphertoEncZip(OutputStream out, String password) throws Exception {
            String passphrase = Utils.pbkdf2(password, Utils.byteArrayToHexString(salt), 1000, CoreCryptoV0.KEY_SIZE_BYTES);
